...
beautiful.init("/home/tom/.config/awesome/theme.lua")
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "1:term", "2:web", "3:music", 4, 5, 6 }, s, layouts[1])
end
-- }}}
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "u", function ()
        local matcher = function(c) 
            return awful.rules.match(c, {class = "HipChat"})
        end
        awful.client.run_or_raise("hipchat", matcher)
    end),
    awful.key({ modkey,           }, "t", function ()
        local matcher = function(c) 
            return awful.rules.match(c, {class = "Gnome-terminal"})
        end
        awful.client.run_or_raise("gnome-terminal", matcher)
    end),
    ...
    awful.key({}, "XF86AudioPrev", function () awful.util.spawn("dbus-send --print-reply --dest=org.mpris.MediaPlayer2.spotify /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.Previous") end),
     ...
     -- awful.key({ }, "XF86AudioRaiseVolume", function () awful.util.spawn("amixer set Master 2+ unmute") end),
...
client.connect_signal("focus", function(c) c.border_color = "#FFA1A1" end)
